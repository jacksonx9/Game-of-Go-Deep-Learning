...
def generate_game(board_size, rounds, max_moves, temperature):
    ...
    while not game.is_over():
        ...
        # Afterwards the bot move is applied to the board.
...
def main():
    ...
    for i in range(args.num_games):
        ...
        # For the specified number of games generate game data.
    ...
    # Store feature and label data to separate files as specified .
