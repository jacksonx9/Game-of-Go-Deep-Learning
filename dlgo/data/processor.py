...
class GoDataProcessor:
    ...
    def load_go_data(self, data_type='train',
        ...
        # Download all games from KGS to our local data directory.
        ...
        for filename, index in data:
            # Collect all zip file names contained in the data in a list.
            zip_names.add(filename)
            if filename not in indices_by_zip_name:
                indices_by_zip_name[filename] = []
            # Group all SGF file indices by zip file name.
        ...
        return features_and_labels  # Features and labels from each zip.
