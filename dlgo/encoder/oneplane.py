...
class OnePlaneEncoder(Encoder):
    ...
    def encode(self, game_state):
        '''To encode, we fill a matrix with 1 if the point contains one 
        of the current player's stones, -1 if the point contains the 
        opponent's stones and 0 if the point is empty.'''
